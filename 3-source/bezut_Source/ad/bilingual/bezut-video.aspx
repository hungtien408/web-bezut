<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="bezut-video.aspx.cs" Inherits="ad_single_video" ValidateRequest="false" %>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Video mới" SortExpression="IsNew" Visible="False">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsNew" runat="server" Checked='<%# string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew") %>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Video Hot" SortExpression="IsHot">
                        <ItemTemplate>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 325px x 229px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left">
                                ...
                                <tr>
                                    <td class="left" colspan="2">
                                        <asp:CheckBox ID="chkIsHot" runat="server" CssClass="checkbox" Text=" Video Hot" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsHot").ToString()) ? false : Eval("IsHot"))%>' />
                                        &nbsp;&nbsp;
                                        <asp:CheckBox ID="chkIsNew" runat="server" CssClass="checkbox" Text=" Video mới" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew"))%>' Visible="False"/>
                                        &nbsp;&nbsp;
