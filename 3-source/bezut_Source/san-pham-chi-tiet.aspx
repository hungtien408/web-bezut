        ...
        <div class="modal-dialog modal-480" role="document">
            <div class="modal-content">
                        ...
                        <div class="modal-body form-wrap">
                            ...
                            <%--<div class="form-input">
                                <label class="form-lb">
                                    Đường/Phố:</label>
                                <div class="form-w">
                                    <asp:TextBox ID="txtDuong" CssClass="form-text" runat="server"></asp:TextBox>
                                </div>
                            </div>--%>
                            <div class="form-input">
                                <label class="form-lb">
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnGui" CssClass="btn btn-primary btn-form" runat="server" Text="Gửi"
                        OnClick="btnGui_Click" ValidationGroup="SendInfo" />
                    <asp:Button ID="btnHuy" CssClass="btn btn-primary btn-form" runat="server" Text="Huỷ"
