    ...
    <asp:ListView ID="lstDieuTriHoNoiBat" runat="server" DataSourceID="odsDieuTriHoNoiBat"
        ...
        <ItemTemplate>
            ...
            <asp:ListView ID="lstListDieuTriHo" runat="server" DataSourceID="odsListDieuTriHo"
                EnableModelValidation="True">
                <ItemTemplate>
                    <li><a href='<%# progressTitle(Eval("ArticleTitle")) + "-dti-" + Eval("ArticleCategoryID") + "-di-" + Eval("ArticleID") + ".aspx" %>'>
        ...
        <ItemTemplate>
            <div class="col-xs-6 element-item">
                <div class="box-newsa">
                    ...
                    <h3 class="news-name">
                        <a href='<%# progressTitle(Eval("ArticleTitle")) + "-dti-" + Eval("ArticleCategoryID") + "-di-" + Eval("ArticleID") + ".aspx" %>'>
                            <%# TLLib.Common.SplitSummary(Eval("ArticleTitle").ToString(), 40)%></a></h3>
                </div>
            </div>
        </ItemTemplate>
        <LayoutTemplate>
