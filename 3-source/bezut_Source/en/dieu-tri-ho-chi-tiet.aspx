...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:ListView ID="lstDieuTriHoDetails" runat="server" DataSourceID="odsDieuTriHoDetails"
        ...
        <ItemTemplate>
            ...
            <div class="wrapper-text">
                <asp:Label ID="lblContentEn" runat="server" Text='<%# Eval("ContentEn") %>'></asp:Label>
            </div>
        </ItemTemplate>
        <LayoutTemplate>
    ...
    <asp:ListView ID="lstDieuTriHo" runat="server" DataSourceID="odsDieuTriHo" EnableModelValidation="True">
        <ItemTemplate>
            <div class="news-lbox">
                ...
                <div class="news-content">
                    <h3 class="news-name">
                        <a href='<%# progressTitle(Eval("ArticleTitleEn")) + "-dti-" + Eval("ArticleCategoryID") + "-di-" + Eval("ArticleID") + ".aspx" %>'><%# Eval("ArticleTitleEn") %></a></h3>
