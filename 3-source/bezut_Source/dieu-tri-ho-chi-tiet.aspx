<%@ Page Title="" Language="C#" MasterPageFile="~/site-msub.master" AutoEventWireup="true"
    CodeFile="dieu-tri-ho-chi-tiet.aspx.cs" Inherits="dieu_tri_ho_chi_tiet" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:ListView ID="lstDieuTriHoDetails" runat="server" DataSourceID="odsDieuTriHoDetails"
    ...
    <asp:ObjectDataSource ID="odsDieuTriHoDetails" runat="server" SelectMethod="ArticleSelectOne"
        TypeName="TLLib.Article">
        <SelectParameters>
            <asp:QueryStringParameter Name="ArticleID" QueryStringField="di" Type="String" />
        </SelectParameters>
    ...
    <%--<div class="news-lbox">
        <a href="tin-tuc-chi-tiet.aspx" class="news-img"><img src="assets/images/dieutriho-img-1.jpg" alt=""/></a>
        <div class="news-content">
            <h3 class="news-name"><a href="tin-tuc-chi-tiet.aspx">Tác động đáng sợ của nước tăng lực đối với người tập thể thao</a></h3>
            <div class="description">Thời tiết những ngày này liên tục thay đổi, ngày nắng ấm, đêm trở lạnh, độ ẩm không khí cao khiến tỷ lệ trẻ bị các bệnh đường hô hấp tăng hơn so với bình thường. Tuy nhiên, không phải cha mẹ nào cũng...</div>
        </div>
    </div>
    <div class="news-lbox">
        <a href="tin-tuc-chi-tiet.aspx" class="news-img"><img src="assets/images/dieutriho-img-1.jpg" alt=""/></a>
    ...
    <asp:ListView ID="lstDieuTriHo" runat="server" DataSourceID="odsDieuTriHo" EnableModelValidation="True">
        <ItemTemplate>
            <div class="news-lbox">
                <a href='<%# progressTitle(Eval("ArticleTitle")) + "-dti-" + Eval("ArticleCategoryID") + "-di-" + Eval("ArticleID") + ".aspx" %>' class="news-img">
                ...
                <div class="news-content">
                    <h3 class="news-name">
                        <a href='<%# progressTitle(Eval("ArticleTitle")) + "-dti-" + Eval("ArticleCategoryID") + "-di-" + Eval("ArticleID") + ".aspx" %>'><%# Eval("ArticleTitle") %></a></h3>
    ...
    <asp:ObjectDataSource ID="odsDieuTriHo" runat="server" SelectMethod="ArticleSameSelectAll"
        TypeName="TLLib.Article">
        <SelectParameters>
            <asp:Parameter Name="RerultCount" Type="String" DefaultValue="5" />
            <asp:QueryStringParameter Name="ArticleID" QueryStringField="di"
                Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
</asp:Content>
