<%@ Page Title="" Language="C#" MasterPageFile="~/site-kienthuc.master" AutoEventWireup="true"
    CodeFile="kien-thuc-benh-hoc-sub.aspx.cs" Inherits="kien_thuc_benh_hoc_sub" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <%--<title>BEZUT </title>--%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphAsideBottom" runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphAsideTop" runat="Server">
    <div class="adv">
        <a href="#">
            <img src="assets/images/images-3.jpg" alt="" /></a>
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<div class="news-big line-bottom mb12">
        <a href="kien-thuc-chi-tiet.aspx" class="news-img"><img src="assets/images/news-img-1.jpg" alt=""/></a>
        <div class="news-content">
            ...
            <div class="more-details"><a href="kien-thuc-chi-tiet.aspx">Xem chi tiết</a></div>
        </div>
    </div>--%>
    <asp:ListView ID="lstKienThucNoiBat" runat="server" DataSourceID="odsKienThucNoiBat"
    ...
    <asp:ObjectDataSource ID="odsKienThucNoiBat" runat="server" SelectMethod="ArticleSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:QueryStringParameter QueryStringField="kri" Name="ArticleCategoryID" Type="String" />
