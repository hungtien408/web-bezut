    ...
    public class Product
    {
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@ProductLink", string.IsNullOrEmpty(ProductLink) ? dbNULL : (object)ProductLink);
                cmd.Parameters.AddWithValue("@ProductLinkEn", string.IsNullOrEmpty(ProductLinkEn) ? dbNULL : (object)ProductLinkEn);
