...
public partial class ad_single_productcategory : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        {
            string ProductCategoryID, IsShowOnMenu, IsShowOnHomePage, IsAvailable, IsTitle;
            ...
            foreach (GridDataItem item in RadGrid1.Items)
            {
                ...
                IsTitle = ((CheckBox)item.FindControl("chkIsTitle")).Checked.ToString();
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string strIsTitle = ((CheckBox)row.FindControl("chkIsTitle")).Checked.ToString();
            ...
            string strProductCategoryLink = ((RadTextBox)row.FindControl("txtProductCategoryLink")).Text.Trim();
            string strProductCategoryLinkEn = ((RadTextBox)row.FindControl("txtProductCategoryLinkEn")).Text.Trim();
            string strPrice = ((RadNumericTextBox)row.FindControl("txtPrice")).Text.Trim();
            ...
            if (e.CommandName == "PerformInsert")
            {
                strImageName = oProductCategory.ProductCategoryInsert(
                    ...
                    strIsAvailable,
                    strIsTitle,
                    strProductCategoryLink,
                    strProductCategoryLinkEn
                );
            ...
            else
            {
                ...
                dsUpdateParam["Description"].DefaultValue = strPrice;
                ...
                dsUpdateParam["IsTitle"].DefaultValue = strIsTitle;
