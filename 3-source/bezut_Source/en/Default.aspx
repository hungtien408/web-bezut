...
<asp:Content ID="Content4" ContentPlaceHolderID="cphAsideBottom" runat="Server">
    <div id="facebook">
        ...
        <div class="fb-page" data-href="https://www.facebook.com/bacsibezut" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/bacsibezut"><a href="https://www.facebook.com/bacsibezut">Bezut</a></blockquote></div></div>
    </div>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="head lineh">
        ...
        <asp:ListView ID="lstDanhMucTinTuc" runat="server" DataSourceID="odsDanhMucTinTuc"
            ...
            <ItemTemplate>
                <a href='<%# progressTitle(Eval("ArticleCategoryNameEn")) + "-tci-" + Eval("ParentID") + "-tri-" + Eval("ArticleCategoryID") + ".aspx" %>'><%# Eval("ArticleCategoryNameEn")%></a>
            </ItemTemplate>
            <LayoutTemplate>
                <div class="head-list">
                    <span runat="server" id="itemPlaceholder" />
    ...
    <div class="wrap-section">
        ...
        <asp:ListView ID="lstTinTuc" runat="server" DataSourceID="odsTinTuc" EnableModelValidation="True">
            <ItemTemplate>
                <div class="section-box">
                    <a href='<%# progressTitle(Eval("ArticleTitleEn")) + "-tci-" + Eval("ArticleCategoryID") + "-tt-" + Eval("ArticleID") + ".aspx" %>' class="section-img">
                        ...
                        <span class="section-name">
                            <%# Eval("ArticleTitleEn") %></span> </a>
                    <div class="description">
                        <%# TLLib.Common.SplitSummary(Eval("DescriptionEn").ToString(), 280) %></div>
                </div>
                <asp:ListView ID="lstListTinTuc" runat="server" DataSourceID="odsListTinTuc" EnableModelValidation="True">
                    <ItemTemplate>
                        <li><a class="section-img" href='<%# progressTitle(Eval("ArticleTitleEn")) + "-tci-" + Eval("ArticleCategoryID") + "-tt-" + Eval("ArticleID") + ".aspx" %>'>
                            ...
                            <div class="section-content">
                                ...
                                <div class="description">
                                    <%# TLLib.Common.SplitSummary(Eval("DescriptionEn").ToString(), 50) %></div>
                            </div>
                        </li>
                    </ItemTemplate>
                    <LayoutTemplate>
        ...
        <div class="more-all">
            <a href="tin-tuc.aspx"><span>See all</span></a>
        </div>
    </div>
    <!--section 2-->
    <div class="head lineh">
    ...
    <div class="wrap-section">
        ...
        <asp:ListView ID="lstDieuTriHo" runat="server" DataSourceID="odsDieuTriHo" EnableModelValidation="True">
            <ItemTemplate>
                <div class="section-box">
                    <a href='<%# progressTitle(Eval("ArticleTitleEn")) + "-dti-" + Eval("ArticleCategoryID") + "-di-" + Eval("ArticleID") + ".aspx" %>' class="section-img">
                ...
                <asp:ListView ID="lstListDieuTriHo" runat="server" DataSourceID="odsListDieuTriHo"
                    EnableModelValidation="True">
                    <ItemTemplate>
                        <li><a class="section-img" href='<%# progressTitle(Eval("ArticleTitleEn")) + "-dti-" + Eval("ArticleCategoryID") + "-di-" + Eval("ArticleID") + ".aspx" %>'>
                            <img alt='<%# Eval("ImageName") %>' src='<%# !string.IsNullOrEmpty(Eval("ImageName").ToString()) ? "~/res/article/" + Eval("ImageName") : "~/assets/images/news-img-1.jpg" %>'
                                runat="server" /></a>
                            <div class="section-content">
                                <h3 class="section-name">
        ...
        <div class="more-all">
            <a href="dieu-tri-ho.aspx"><span>See all</span></a>
        </div>
    </div>
    <!--section 3-->
    <div class="head lineh">
    ...
    <div class="wrap-section">
        ...
        <asp:ListView ID="lstKienThucBenhHoc" runat="server" DataSourceID="odsKienThucBenhHoc"
            ...
            <ItemTemplate>
                <div class="col-xs-4">
                    <div class="box-news">
                        <a class="section-img" href='<%# progressTitle(Eval("ArticleTitleEn")) + "-kci-" + Eval("ArticleCategoryID") + "-ki-" + Eval("ArticleID") + ".aspx" %>'>
                            <img alt='<%# Eval("ImageName") %>' src='<%# !string.IsNullOrEmpty(Eval("ImageName").ToString()) ? "~/res/article/" + Eval("ImageName") : "~/assets/images/news-img-1.jpg" %>'
                                runat="server" /></a>
                        <div class="section-content">
                            <h3 class="section-name">
        ...
        <div class="more-all">
            <a href="kien-thuc-benh-hoc.aspx"><span>See all</span></a>
        </div>
    </div>
    <!--section4-->
    ...
    <%--<asp:ListView ID="lstDanhMucSanPham" runat="server" DataSourceID="odsDanhMucSanPham"
        ...
        <ItemTemplate>
            <div class="col-xs-4 element-item">
                <div class="product-box">
                    <a href='<%# Eval("ProductCategoryLinkEn") %>' class="product-img">
