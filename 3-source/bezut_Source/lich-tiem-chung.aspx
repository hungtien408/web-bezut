<%@ Page Title="" Language="C#" MasterPageFile="~/site-tiemchung.master" AutoEventWireup="true" CodeFile="lich-tiem-chung.aspx.cs" Inherits="lich_tiem_chung" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Xem thời điểm tiêm phòng cho bé yêu của bạn:</strong></p>
    <ul class="list-tc">
        ...
        <li><a href="javascript:void(0);">Bệnh viêm màng não do Não mô cầu tuýp A + C</a></li>
