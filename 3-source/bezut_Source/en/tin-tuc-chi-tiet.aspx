...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="headno">
        <h1 class="title text-uppercase">
            <asp:Label ID="lblTitleNews" runat="server"></asp:Label></h1>
    </div>
    ...
    <asp:ListView ID="lstTinTucDetails" runat="server" DataSourceID="odsTinTucDetails"
        EnableModelValidation="True">
        <ItemTemplate>
            <div class="wrapper-text">
                <h2>
                    <%# Eval("ArticleTitleEn") %></h2>
    ...
    <asp:ObjectDataSource ID="odsTinTucDetails" runat="server" SelectMethod="ArticleSelectOne"
