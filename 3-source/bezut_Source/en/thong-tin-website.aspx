<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-news.master" AutoEventWireup="true"
    CodeFile="thong-tin-website.aspx.cs" Inherits="tin_tuc_sub" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<asp:ListView ID="lstTinTucNoiBat" runat="server" DataSourceID="odsTinTucNoiBat"
        ...
        <ItemTemplate>
            <div class="news-big line-bottom mb12">
                ...
                <div class="news-content">
                    <h3 class="news-name">
                        <a href='<%# progressTitle(Eval("ArticleTitle")) + "-tci-" + Eval("ArticleCategoryID") + "-tt-" + Eval("ArticleID") + ".aspx" %>'><%# Eval("ArticleTitle") %></a></h3>
    ...
    <asp:ObjectDataSource ID="odsTinTuc" runat="server" SelectMethod="ArticleSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="ArticleTitle" Type="String" />
            <asp:Parameter Name="Description" Type="String" />
            <asp:QueryStringParameter DefaultValue="16" QueryStringField="tri" Name="ArticleCategoryID" Type="String" />
            <asp:Parameter Name="Tag" Type="String" />
            <asp:Parameter Name="IsShowOnHomePage" Type="String" />
