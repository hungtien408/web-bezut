...
public partial class ad_single_video : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        {
            string VideoID, Priority, IsAvailable, IsHot, IsNew, IsShowOnHomePage;
            var oVideo = new Video();
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            var strIsHot = ((CheckBox)row.FindControl("chkIsHot")).Checked.ToString();
            var strIsNew = ((CheckBox)row.FindControl("chkIsNew")).Checked.ToString();
            var strIsShowOnHomePage = ((CheckBox)row.FindControl("chkIsShowOnHomePage")).Checked.ToString();
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                dsInsertParam["IsHot"].DefaultValue = strIsHot;
                dsInsertParam["IsNew"].DefaultValue = strIsNew;
