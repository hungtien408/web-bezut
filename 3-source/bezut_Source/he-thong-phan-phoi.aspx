...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<div class="row isotopelist list-dsitri">
        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Hà Nội</a></div>
        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Nam Định</a></div>
        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Ninh Bình</a></div>
        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Quảng Ninh 1</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Bắc Ninh</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Hải Phòng</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Hòa Bình</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Hải Dương</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Hưng Yên</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Bắc Giang</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Phú Thọ</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Thái Nguyên</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Vĩnh Phúc</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Thái Bình</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Sơn Tây</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Yên Bái</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Tuyên Quang</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Cao Bằng</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Lào Cai</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Hà nam</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Quảng Ninh 2</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Sơn La</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Điện Biên</a></div>        <div class="col-xs-3 element-item"><a href="he-thong-phan-phoi-sub.aspx">Lạng sơn</a></div>
    </div>--%>
    <asp:ListView ID="lstMienBac" runat="server" DataSourceID="odsMienBac" EnableModelValidation="True">
        <ItemTemplate>
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-4 element-item">
                <a href='<%# progressTitle(Eval("ProvinceName")) + "-pvi-" + Eval("ProvinceID") + ".aspx" %>'><%# Eval("ProvinceName")%></a></div>
        </ItemTemplate>
        <LayoutTemplate>
            <div class="row isotopelist list-dsitri">
