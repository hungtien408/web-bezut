    ...
    public class ProductCategory
    {
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@IsTitle", string.IsNullOrEmpty(IsTitle) ? dbNULL : (object)IsTitle);
                cmd.Parameters.AddWithValue("@ProductCategoryLink", string.IsNullOrEmpty(ProductCategoryLink) ? dbNULL : (object)ProductCategoryLink);
                cmd.Parameters.AddWithValue("@ProductCategoryLinkEn", string.IsNullOrEmpty(ProductCategoryLinkEn) ? dbNULL : (object)ProductCategoryLinkEn);
        ...
        public DataTable ProductCategorySelectAll(int parentID, int increaseLevelCount, string IsShowOnMenu, string IsShowOnHomePage, string IsTitle)
        {
            try
            {
                var dt = new DataTable();
                ...
                oCommon.RecursiveFillTree1(dt, parentID, "ParentID", "ProductCategoryName", "ProductCategoryID", increaseLevelCount, IsShowOnMenu, IsShowOnHomePage, IsTitle);
