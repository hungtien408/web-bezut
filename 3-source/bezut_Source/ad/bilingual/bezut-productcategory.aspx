<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="bezut-productcategory.aspx.cs" Inherits="ad_single_productcategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn DataField="IsTitle" HeaderText="Xem trên tiêu đề">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsTitle" runat="server" Checked='<%# Eval("IsTitle") == DBNull.Value ? false : Convert.ToBoolean(Eval("IsTitle"))%>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                ...
                                <img alt="" src='<%# "~/res/productcategory/" + Eval("ImageName") %>' width="80"
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadNumericTextBox ID="txtPrice" runat="server" Width="500px" rel="price" Text='<%# Bind("Description") %>'
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProductCategoryLink" runat="server" Text='<%# Bind("ProductCategoryLink") %>'
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProductCategoryLinkEn" runat="server" Text='<%# Bind("ProductCategoryLinkEn") %>'
                                            Width="500px" EmptyMessage="Link...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="left" colspan="2">
                                        <asp:CheckBox ID="chkIsTitle" runat="server" Checked='<%# (Container is GridEditFormInsertItem) ? true : (Eval("IsTitle") == DBNull.Value ? false : Convert.ToBoolean(Eval("IsTitle"))) %>'
                                            CssClass="checkbox" Text=" Xem trên tiêu đề" />
                                        &nbsp;&nbsp;
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductCategoryDelete"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="ProductCategoryLink" Type="String" />
            <asp:Parameter Name="ProductCategoryLinkEn" Type="String" />
        </InsertParameters>
        <UpdateParameters>
            <asp:Parameter Name="ProductCategoryID" Type="String" />
            <asp:Parameter Name="ProductCategoryName" Type="String" />
